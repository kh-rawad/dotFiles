...
if [[ ! "$PATH" == *$FZF_BASE* ]]; then
  PATH="${PATH:+${PATH}:}$FZF_BASE"
fi
## key bindings
FZF_ALT_C_COMMAND='find . -maxdepth 1'
...
# configure tmux
## Automatically start tmux when logging in
export ZSH_TMUX_AUTOSTART="true"
## Automatically closes terminal once tmux exits
export ZSH_TMUX_AUTOQUIT="true"
## Automatically name new sessions based on the basename of $PWD
export ZSH_TMUX_AUTONAME_SESSION="true"
## if running in iTerm2
[[ $TERM_PROGRAM == "iTerm.app" ]] && export ZSH_TMUX_ITERM2="true" || export ZSH_TMUX_ITERM2="false"
